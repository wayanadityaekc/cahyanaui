...
export default function DateField({ label = 'Date', value, onChange, min, placeholder = 'Select date', name, id }) {
  ...
  return (
    <div className="csel-group">
      ...
      <button type="button" className="hs-control bk-control" aria-haspopup="dialog" aria-expanded={open} onClick={() => setOpen(true)}>
