...
const CLS = {
  ...
  logoImg: 'h-[30px] w-auto transition-[transform] duration-200 ease-[ease] hover:-translate-y-[2px]',
  socials: 'flex items-center justify-center gap-6',
  socialImg: 'h-[30px] w-auto transition-[transform] duration-200 ease-[ease]',
