...
// pre-filled with these dates/guests".
export default function SearchCard() {
  ...
  return (
    <div className="card relative z-10 mx-auto -mt-10 sm:-mt-12 max-w-4xl grid grid-cols-2 sm:grid-cols-4 gap-2 p-3">
      <div className="field-shell col-span-1">
      ...
      <button
        type="button"
        className="btn btn-cta col-span-2 sm:col-span-1"
