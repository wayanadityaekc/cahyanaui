...
// ===== Pickup surcharge (stay-area based) - PLACEHOLDER, CEK WAYAN =====
// Flat fee dikenakan HANYA kalau stay-area tamu != Ubud DAN != zona item.
const PICKUP_SURCHARGE = { usd: 7, idr: 100000 };
const STAY_ZONES = [{ id: "ubud", label: "Ubud & nearby" }, { id: "south", label: "South Bali" }, { id: "east", label: "East Bali" }, { id: "north", label: "North Bali" }];
