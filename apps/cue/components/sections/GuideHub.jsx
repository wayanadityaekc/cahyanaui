...
export default function GuideHub() {
  ...
  return (
    <>
      <section className={`${SUBHERO} !px-[var(--container-x)] !text-left`} style={{ backgroundImage: GUIDE_HUB.heroStyle.replace(/^background-image:\s*/, '').replace(/;$/, ''), backgroundPosition: 'center 60%' }}>
        <div className={`${SUBHERO_CONTENT} !max-w-[calc(var(--container)_-_2_*_var(--container-x))]`}>
          <Breadcrumb
