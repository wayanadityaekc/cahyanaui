...
export const BTN_WA =
  'w-full p-[0.85rem] border-none rounded-pill text-[1rem] font-semibold no-underline cursor-pointer transition-[background-color,color] duration-[var(--dur)] ease-[ease] mt-3 text-white bg-[#25d366] hover:bg-[#1fb457] hover:text-white';
