...
export default function DragSheet({
  ...
  onDismiss,
  className,
  // The grab area. Overridable because a sheet whose own content is layered
  // (a sticky header, say) may need it raised or offset - CUE's sheets have
  // nothing above theirs, so its default is the one CUE ships.
