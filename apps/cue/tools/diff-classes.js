...
const RUNTIME = /^(navbar|footer|acct|tripbar|slider-|itn-|active|inter_|hs-|wa-|card-|binfo|hero__search|hero-sheet|hsearch|placeholder|modal|tour-layout|booksidebar|price-unit|price__sym|booking|csel-|bk-|rating|rvm-|mtc-|reviews-strip|rev|guide-cat-|gsearch|zone-|chdur|chcard|tpick|charter__|at-|dtf|field|amount|btn-book|summary|itn2|pick-cat|drivers-grid|driver-card|driver-modal|about-gallery|anl|is-sel|is-on|guest-|loadscreen|experience__arrow|experience__footer)/;
